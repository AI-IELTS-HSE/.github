...
4. [Встречи и жизненный цикл спринта](#Operational-встречи-и-жизненный-цикл-спринта)
   - [этапим](#1-Этапим-45-мин)
   - [описываем задачи](#2-Асинхронно-описание-задач)
   - [взвешиваем задачи](#3-Асинхронно-взвешивание-задач)
   - [приоритизируем задачи](#4-Приоритизация-задач-30-мин)
   - [планирование задач](#5-Асинхронно-планирование-задач)
5. Продажи продукта
